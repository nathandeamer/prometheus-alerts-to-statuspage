...
public final class AlertWrapperHelper {
    ...
    public static final String STATUSPAGE_COMPONENT_NAME_VALUE = "Status Page Component Name";
    ...
    public static AlertWrapper buildAlertWrapper(Status status, List<Alert> alerts) {
        return AlertWrapper.builder()
                ...
                .commonAnnotations(Map.of(STATUSPAGE_COMPONENT_NAME, STATUSPAGE_COMPONENT_NAME_VALUE))
                .build();
    }
